...
import type { BashOperations, BashResult } from "../bash-executor.js";
...
export interface ExtensionUIContext {
	 ...
	 * extend the host application's custom editor base class and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "<host-application-package>";
	 *
