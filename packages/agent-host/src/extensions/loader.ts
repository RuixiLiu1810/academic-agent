...
// Keep the host facade available to extension loaders in packaged and binary runtimes.
import * as _bundledPiAgentHost from "../index.js";
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@mariozechner/pi-agent-host": _bundledPiAgentHost,
};
...
function getAliases(): Record<string, string> {
	...
	_aliases = {
		"@mariozechner/pi-agent-host": packageIndex,
