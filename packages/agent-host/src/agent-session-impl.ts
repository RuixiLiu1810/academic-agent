...
export interface AgentSessionConfig {
	...
	/** Override default base tool definitions instead of synthesizing coding tools internally. */
	baseToolDefinitionsOverride?: Record<string, ToolDefinition>;
	/** Override the default bash operations factory used by executeBash(). */
	createDefaultBashOperations?: (options: { shellPath?: string }) => BashOperations;
	/** Override HTML export implementation so host packages can supply their own exporter. */
	htmlExporter?: (
		sessionManager: SessionManager,
		state: AgentState,
		options: {
...
export class AgentSession {
	...
	private _createDefaultBashOperations?: (options: { shellPath?: string }) => BashOperations;
	private _htmlExporter?: (
		sessionManager: SessionManager,
		state: AgentState,
		options: {
			outputPath?: string;
	...
	constructor(config: AgentSessionConfig) {
		...
		this._createDefaultBashOperations = config.createDefaultBashOperations;
		this._htmlExporter = config.htmlExporter;
